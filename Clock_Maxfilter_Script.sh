...
for s in 10637 10662 10997 11243 11246 11252 11253 11255 11258 11262 11263; do
	...
	for r in 1 2 3 4 5 6 7 8; do
		...
		-bad $(sed s/MEG// ${s}_clock_bad_run${r}.txt) \
		...
		> /home/hwangk/Luna1/Multimodal/Clock/${s}/MEG/${s}/MEG/${s}_clock_run${r}_sss.log
		...
		> /home/hwangk/Luna1/Multimodal/Clock/${s}/MEG/${s}/MEG/${s}_clock_run${r}_trans.log

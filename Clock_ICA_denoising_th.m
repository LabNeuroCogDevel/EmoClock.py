function Clock_ICA_denoising_th( input, output)
%Function to do ICA denoising on MEG Clock data. This function will read in 
%a fiff file, do ICA decomposition separately on magnetometers and
%gradiometers, identify components highly correlated with EOG and ECG
%signals (threshold set to abs(r)>mean(abs(r)+2.5*std(abs(r))), then project
